...
// PQ2_0: Prism-private Q2_0 at group size 128 (byte-identical to the original Q2_0
// before Q2_0 was changed to group size 64). Kept as a separate type so the two
// formats stay fully decoupled.
#define QKP2_0 128
typedef struct {
    ggml_half d;               // delta (scale)
    uint8_t qs[QKP2_0 / 4];   // 2 bits per element
} block_pq2_0;
static_assert(sizeof(block_pq2_0) == sizeof(ggml_half) + QKP2_0 / 4, "wrong pq2_0 block size/padding");
